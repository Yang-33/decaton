...
. CI validation: you can run any JSON Schema validator (e.g. https://github.com/ajv-validator/ajv[`ajv-validator/ajv`], https://github.com/python-jsonschema/jsonschema[`python-jsonschema/jsonschema`]) in a build or deploy pipeline to prevent invalid configurations from reaching production.


[source,json]
----
{
  "$schema": "https://raw.githubusercontent.com/line/decaton/v9.0.0/jsonschema/dist/decaton-processor-properties-schema-draft_7.json",
...
Draft 7 remains the widest-supported choice today, but newer validators work fine with 2019-09 or 2020-12.
